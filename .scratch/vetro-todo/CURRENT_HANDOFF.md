...
Обновлено: 2026-07-29, после TICKET-05.
...
Нет. Следующий — TICKET-06.

## Next eligible ticket

**TICKET-06** (`issues/06-details-rating-fact-card.md`, пункт 7) — рейтинг мини-карточкой, верхние чипсы убрать. Не заблокирован.

Дальше: TICKET-07 → TICKET-08 (блокируется 07) → TICKET-09 (блокируется 05, то есть уже разблокирован).
