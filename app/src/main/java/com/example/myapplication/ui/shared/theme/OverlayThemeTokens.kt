...
internal object OverlayThemeTokens {
    ...
    /**
     * Поверхность выпадающего меню в меню серий (тёмная тема) — #333333.
     *
     ...
     */
    val EpisodeMenuSurfaceDark = Color(0xFF333333)

    // ============================================================
    // Акценты меню сортировки и меню категорий
    // ============================================================
    /**
     * Тёплый ряд акцентов для пунктов меню сортировки и плиток категорий.
     *
     ...
     * — из-за этого пункты «по названию» и «по жанрам» выглядели блёклыми.
     *
     * Ряд остаётся внутри брендового семейства (оранжевый → янтарь), новых оттенков не вводит и
     * не трогает золотой #FFD600: тот закреплён за избранным ([FavoriteCardBorder]) и смешивать
     * роли нельзя.
     */
    val SortAccentPrimary = Color(0xFFE85002)
    val SortAccentSecondary = Color(0xFFFF7A1A)
    val SortAccentTertiary = Color(0xFFFF9500)
    val SortAccentQuaternary = Color(0xFFFFB300)
