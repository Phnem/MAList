...
private val RussianNotificationStrings = NotificationStrings(
    ...
    notifUpdateTitleFormat = "Новая серия: %s",
    notifUpdateBodyFormat = "Отмечено в коллекции: %1\$d → %2\$d эп.",
    notifGroupSummaryFormat = "Новые серии: %d",
...
private val EnglishNotificationStrings = NotificationStrings(
    ...
    notifUpdateTitleFormat = "New episode: %s",
    notifUpdateBodyFormat = "Marked in your collection: %1\$d → %2\$d ep.",
    notifGroupSummaryFormat = "New episodes: %d",
